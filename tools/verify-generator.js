"use strict";
// Full <=3-piece verification of the generator against the originally
// shipped tables: every shipped entry must be present in the solve with an
// identical VALUE. Distances are compared but not required to match:
// shipped distances are non-canonical artifacts of the original bounded
// forward generation (see BUGS.md #12); ours are canonical fastest-win /
// slowest-loss. The original values live in testdata/ as v3 fixtures now
// that the canonical end8* files are regenerated <=4-piece v4 tables.
var fs = require('fs');
...
var failed = false;
[{ file: 'testdata/end8Forced.v3', forced: true },
 { file: 'testdata/end8Unforced.v3', forced: false }].forEach(function (cfg) {
